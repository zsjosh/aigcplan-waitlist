            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <input
                  ...
                  required
                  className="w-full px-8 py-5 text-base rounded-xl bg-gray-800/50 border border-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition-all hover:bg-gray-800/70"
                />
                <input
                  type="text"
                  value={nickname}
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl font-medium text-base hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all disabled:opacity-50 disabled:cursor-not-allowed relative group overflow-hidden"
              >
